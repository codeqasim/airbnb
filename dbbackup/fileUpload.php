...
$client->setClientId('131614080449-05kkksafeo1qmn2qdrgoor0kgu4hn2q2.apps.googleusercontent.com');
$client->setClientSecret('mMJkNqCmkoaJQDjklo_V_D0t');
$client->setRedirectUri('http://coreteam.casperon.com/renters/dbbackup/fileUpload.php');
